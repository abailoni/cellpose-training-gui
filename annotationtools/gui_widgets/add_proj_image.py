# Import numpy to allow Pydantic resolve forward references of type hints ("numpy" in quotes).
...
from napari_spacem_grid_fit.utils import connect_once
from napari_spacem_grid_fit.widgets.cartesian_grid_view import (
    DOCK_DISPLAY_NAME,
    CartesianGridView,
...
from spacem_lib.typing import Coordinate2dListType, Coordinate2dType, LabelImageType, Shape2dType
from spacem_lib.utils.dimension_utils import convert_matrix_dims
from spacem_lib.utils.pydantic_utils import ArbitraryTypesModel, NumpyNDArray
...
class AddNewImageToProject:
    def __init__(self, project):
        assert isinstance(project, BaseAnnotationExperiment)
